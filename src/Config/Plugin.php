...
use WoogaEnhancedEcommerce\Common\Traits\Singleton;
...
final class Plugin {
	...
	public function data(): array {
		$plugin_data = apply_filters( 'wooga_enhanced_ecommerce_plugin_data', [
			'settings'               => get_option( 'wooga-enhanced-ecommerce-settings' ),
			'plugin_path'            => untrailingslashit(
				plugin_dir_path( WOOGA_ENHANCED_ECOMMERCE_PLUGIN_FILE )  // phpcs:disable ImportDetection.Imports.RequireImports.Symbol -- this constant is global
			),
			'plugin_template_folder' => 'templates',
			'ext_template_folder'    => 'wooga-enhanced-ecommerce-templates',
			/**
			 * Add extra data here
			 */		
		] );
		return array_merge(
			apply_filters( 'wooga_enhanced_ecommerce_plugin_meta_data',
				get_file_data( WOOGA_ENHANCED_ECOMMERCE_PLUGIN_FILE, // phpcs:disable ImportDetection.Imports.RequireImports.Symbol -- this constant is global
					[
						'name'         => 'Plugin Name',
						'uri'          => 'Plugin URI',
