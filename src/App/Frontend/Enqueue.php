		...
		foreach (
			[
				[
					...
					'media'   => 'all',
					'source'  => plugins_url( '/assets/public/css/frontend.css', WOOGA_ENHANCED_ECOMMERCE_PLUGIN_FILE ), // phpcs:disable ImportDetection.Imports.RequireImports.Symbol -- this constant is global
		...
		foreach (
			[
				[
					...
					'in_footer' => true,
					'source'    => plugins_url( '/assets/public/js/frontend.js', WOOGA_ENHANCED_ECOMMERCE_PLUGIN_FILE ), // phpcs:disable ImportDetection.Imports.RequireImports.Symbol -- this constant is global
					'version'   => $this->plugin->version(),
				],
			] as $js ) {
