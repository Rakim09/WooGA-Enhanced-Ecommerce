...
use WoogaEnhancedEcommerce\Common\Traits\Requester;
use WoogaEnhancedEcommerce\Common\Utils\Errors;
use WoogaEnhancedEcommerce\Config\Classes;
use WoogaEnhancedEcommerce\Config\I18n;
use WoogaEnhancedEcommerce\Config\Requirements;
...
final class Bootstrap extends Base {
	...
	public function initClasses() {
		$this->class_list = \apply_filters( 'wooga_enhanced_ecommerce_initialized_classes', $this->class_list );
		foreach ( $this->class_list as $class ) {
			try {
				...
				\do_action( 'wooga_enhanced_ecommerce_class_initialize_failed', $err, $class );
				Errors::wpDie(
					...
					__( 'Plugin initialize failed', 'wooga-enhanced-ecommerce' ),
					__FILE__, $err
				);
			}
		}
	...
	public function getClasses( string $namespace ): array {
		...
		// Errors::writeLog(
		//    [
		//        'title'   => __( 'WooGA Enhanced Ecommerce classes are not being loaded by Composer\'s Autoloader' ),
