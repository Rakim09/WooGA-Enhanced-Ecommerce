...
namespace WoogaEnhancedEcommerce\Integrations\Widget;
 ...
 * Class HTML_Widget
 *
 * @package WoogaEnhancedEcommerce\Integrations\Widget
 */
class HTML_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = [
			...
			'description'                 => __( 'Displays HTML code with syntax highlighting.', 'wooga-enhanced-ecommerce' ),
			'customize_selective_refresh' => true,
		];
		$control_ops = [];
		parent::__construct( 'wooga-enhanced-ecommerce', __( 'HTML Test Widget', 'wooga-enhanced-ecommerce' ), $widget_ops, $control_ops );
	}
	...
	public function widget( $args, $instance ) {
		 ...
		 * @since 0.1.0
		 */
		$content = apply_filters( 'wooga_enhanced_ecommerce_html_widget_content', $content, $instance, $this );
	...
	public function form( $instance ) {
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'content' ) ); ?>" class="screen-reader-text"><?php esc_html_e( 'Content:', 'wooga-enhanced-ecommerce' ); ?></label>
